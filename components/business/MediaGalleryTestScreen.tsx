...
export const MediaGalleryTestScreen: React.FC<MediaGalleryScreenProps> = ({ navigation }) => {
  // Mock user and business data for testing
  const mockUser = { uid: 'test-user', email: 'test@example.com' };
  const mockBusiness = { id: 'test-business', name: 'Test Business' };
  
  const [userBusiness, setUserBusiness] = useState(mockBusiness);
  ...
  const handleAddMedia = () => {
    ...
    // For mobile testing in Expo Go, use Alert
    Alert.alert(
      'Add Media',

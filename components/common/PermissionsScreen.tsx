  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={[styles.button, requesting && { opacity: 0.6 }]} disabled={requesting} onPress={requestAll}>
        <Ionicons name="checkmark-circle" size={22} color={colors.headerText} />
...
const localStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: '700', color: colors.text, marginTop: 16, textAlign: 'center' },
  subtitle: { fontSize: 14, color: colors.textSecondary, marginTop: 8, textAlign: 'center', lineHeight: 20 },
  button: { marginTop: 24, backgroundColor: colors.primary, paddingHorizontal: 20, paddingVertical: 14, borderRadius: 10, flexDirection: 'row', gap: 8, alignItems: 'center' },
  buttonText: { color: colors.headerText, fontSize: 16, fontWeight: '600' },
